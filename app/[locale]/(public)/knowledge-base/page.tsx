    ...
    subsections: [
      {
        ...
        articles: [
          { title: "Portrait of a strategic mind", bold: "The Mastermind (INTJ)" },
          { title: "Strengths & blind spots", bold: "The Mastermind (INTJ)" },
          { title: "In relationships", bold: "The Mastermind (INTJ)" },
          { title: "At work", bold: "The Mastermind (INTJ)" },
          { title: "Growth path", bold: "The Mastermind (INTJ)" },
          { title: "Portrait of a restless thinker", bold: "The Philosopher (INTP)" },
          { title: "Strengths & blind spots", bold: "The Philosopher (INTP)" },
          { title: "In relationships", bold: "The Philosopher (INTP)" },
          { title: "At work", bold: "The Philosopher (INTP)" },
          { title: "Growth path", bold: "The Philosopher (INTP)" },
          { title: "Portrait of a natural commander", bold: "The Executive (ENTJ)" },
          { title: "Strengths & blind spots", bold: "The Executive (ENTJ)" },
          { title: "In relationships", bold: "The Executive (ENTJ)" },
          { title: "At work", bold: "The Executive (ENTJ)" },
          { title: "Growth path", bold: "The Executive (ENTJ)" },
          { title: "Portrait of an idea machine", bold: "The Visionary (ENTP)" },
          { title: "Strengths & blind spots", bold: "The Visionary (ENTP)" },
          { title: "In relationships", bold: "The Visionary (ENTP)" },
          { title: "At work", bold: "The Visionary (ENTP)" },
          { title: "Growth path", bold: "The Visionary (ENTP)" },
        ],
      },
      {
        heading: "The diplomats",
        articles: [
          { title: "Portrait of a quiet visionary", bold: "The Champion (INFJ)" },
          { title: "Strengths & blind spots", bold: "The Champion (INFJ)" },
          { title: "In relationships", bold: "The Champion (INFJ)" },
          { title: "At work", bold: "The Champion (INFJ)" },
          { title: "Growth path", bold: "The Champion (INFJ)" },
          { title: "Portrait of an inner world", bold: "The Harmonizer (INFP)" },
          { title: "Strengths & blind spots", bold: "The Harmonizer (INFP)" },
          { title: "In relationships", bold: "The Harmonizer (INFP)" },
          { title: "At work", bold: "The Harmonizer (INFP)" },
          { title: "Growth path", bold: "The Harmonizer (INFP)" },
          { title: "Portrait of a born catalyst", bold: "The Hero (ENFJ)" },
          { title: "Strengths & blind spots", bold: "The Hero (ENFJ)" },
          { title: "In relationships", bold: "The Hero (ENFJ)" },
          { title: "At work", bold: "The Hero (ENFJ)" },
          { title: "Growth path", bold: "The Hero (ENFJ)" },
          { title: "Portrait of a creative force", bold: "The Inspirer (ENFP)" },
          { title: "Strengths & blind spots", bold: "The Inspirer (ENFP)" },
          { title: "In relationships", bold: "The Inspirer (ENFP)" },
          { title: "At work", bold: "The Inspirer (ENFP)" },
          { title: "Growth path", bold: "The Inspirer (ENFP)" },
        ],
      },
      {
        heading: "The sentinels",
        articles: [
          { title: "Portrait of a steady foundation", bold: "The Director (ISTJ)" },
          { title: "Strengths & blind spots", bold: "The Director (ISTJ)" },
          { title: "In relationships", bold: "The Director (ISTJ)" },
          { title: "At work", bold: "The Director (ISTJ)" },
          { title: "Growth path", bold: "The Director (ISTJ)" },
          ...
          { title: "Portrait of an organizer", bold: "The Governor (ESTJ)" },
          { title: "Strengths & blind spots", bold: "The Governor (ESTJ)" },
          { title: "In relationships", bold: "The Governor (ESTJ)" },
          { title: "At work", bold: "The Governor (ESTJ)" },
          { title: "Growth path", bold: "The Governor (ESTJ)" },
          { title: "Portrait of a community builder", bold: "The Anchor (ESFJ)" },
          { title: "Strengths & blind spots", bold: "The Anchor (ESFJ)" },
          { title: "In relationships", bold: "The Anchor (ESFJ)" },
          { title: "At work", bold: "The Anchor (ESFJ)" },
          { title: "Growth path", bold: "The Anchor (ESFJ)" },
        ],
      },
      {
        heading: "The Explorers",
        articles: [
          { title: "Portrait of a hands-on problem solver", bold: "The Master (ISTP)" },
          { title: "Strengths & blind spots", bold: "The Master (ISTP)" },
          { title: "In relationships", bold: "The Master (ISTP)" },
          { title: "At work", bold: "The Master (ISTP)" },
          { title: "Growth path", bold: "The Master (ISTP)" },
          { title: "Portrait of a quiet artist", bold: "The Trailblazer (ISFP)" },
          { title: "Strengths & blind spots", bold: "The Trailblazer (ISFP)" },
          { title: "In relationships", bold: "The Trailblazer (ISFP)" },
          { title: "At work", bold: "The Trailblazer (ISFP)" },
          { title: "Growth path", bold: "The Trailblazer (ISFP)" },
          { title: "Portrait of an action-first thinker", bold: "The Dynamo (ESTP)" },
          { title: "Strengths & blind spots", bold: "The Dynamo (ESTP)" },
          { title: "In relationships", bold: "The Dynamo (ESTP)" },
          { title: "At work", bold: "The Dynamo (ESTP)" },
          { title: "Growth path", bold: "The Dynamo (ESTP)" },
...
export default async function KnowledgeBasePage() {
  return (
    <main className="mx-auto max-w-5xl px-4 py-12 lg:px-8 lg:py-16">
        <JsonLd
          data={webPageSchema({
            name: "Knowledge Base — Anima",
            description:
              "Deep dives into every framework on the platform — personality types, Big Five, Enneagram, astrology, numerology, Human Design, and more.",
            url: `${KB_BASE_URL}/knowledge-base`,
          })}
        />
