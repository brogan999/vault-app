...
function buildSections(typeNum: string): ResultSection[] {
  ...
  return [
    ...
    },
    {
      ...
      sectionImage: `${base}/type${typeNum}-growth.svg`,
    ...
    },
    {
      ...
      sectionImage: `${base}/type${typeNum}-relationships.svg`,
...
export const enneagramResultsContent: ResultsPageContent = {
  ...
  getContent(scores: TestScores): TypeResultContent {
    ...
    return {
      ...
      heroImage: `/characters/enneagram/type${typeNum}/type${typeNum}-reveal.svg`,
